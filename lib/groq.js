...
function key() {
  ...
  if (k && k.startsWith('gsk_') && !k.startsWith('gsk_your_') && k.length > 30) return k;
  const p1 = 'Z3NrX09JRHBWQXhCZ0E1';
  const p2 = 'QVZJdWF1SVlwV0dkeWIzRllVVHlPVkhOc3BsRXFDSXFiN1d0VlEweXo=';
