...
// or Cartesia (for English, Hindi, Hinglish, Kannada, Kanglish).
...
// Cartesia native voice IDs for specified languages
const CARTESIA_DEFAULT_VOICES = {
  ...
  Hinglish: process.env.CARTESIA_VOICE_ID_HINDI || 'c1be4806-b6e0-40ea-9932-a887c51cb990',
  Kannada: process.env.CARTESIA_VOICE_ID_KANNADA || '37f0d97c-0c50-409a-b911-459a1ce20052',
  Kanglish: process.env.CARTESIA_VOICE_ID_KANNADA || '37f0d97c-0c50-409a-b911-459a1ce20052'
};
 ...
 *     Hindi/Hinglish: CARTESIA_VOICE_ID_HINDI (c1be4806-b6e0-40ea-9932-a887c51cb990)
 *     Kannada/Kanglish: CARTESIA_VOICE_ID_KANNADA (37f0d97c-0c50-409a-b911-459a1ce20052)
 */
...
async function synthesizeCartesia({ text, language }) {
  ...
  let langKey = 'English';
  if (/hindi|hinglish|^hi/i.test(langLower)) {
    langKey = 'Hindi';
  } else if (/kannada|kanglish|^kn/i.test(langLower)) {
    langKey = 'Kannada';
  } else {
    langKey = 'English';
  }
